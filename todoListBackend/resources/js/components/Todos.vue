    ...
    <div>
        ...
        <form @submit.prevent="addTodo" class="md-3"> 
            ...
            <div class="form-group">
                ...
                <button type="submit" class="btn btn-primary btn-block " value="add todo">{{edit? "Update ":"Add "}}My Todo </button>
            </div>
        </form>
        <!-- pagination -->
        <nav aria-label="Page Navigation Example">
            <ul class="pagination">
                <li v-bind:class="[{ disabled:!pagination.prev_page_url }]" class="page-item">
                    <a class="page-link" href="#" @click="fetchTodos(pagination.prev_page_url)">previous</a></li>

                <li class="page-item disabled">
                    <a class="page-link test-dark" href="#">{{ pagination.current_page }} of {{ pagination.last_page }}</a></li>
           ...
           <!-- search by name -->
            <div class="form-group">
                <input type="text" class="form-control" placeholder="search..." v-model="searchName"> <span><button type="submit" class="btn btn-light btn-block " value="add todo">search</button></span>          
                
            </div>
        </form> 
        <!-- group by different attributes -->
        <span><button type="button" class="btn btn-light " style="width:200px;" value="add todo" @click="fetchTodos()">All</button></span>  <span><button type="submit" class="btn btn-light  " style="width:200px;" value="add todo" @click="fetchNotYetTodos()">Todo</button></span><span><button type="submit" class="btn btn-light " style="width:200px;" @click="fetchDoneTodos()" value="add todo">Done</button></span>  
        </nav>
